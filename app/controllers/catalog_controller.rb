...
class CatalogController < ApplicationController  
 ...
 # before_filter :enforce_show_permissions, :only=>:show
  ...
  configure_blacklight do |config|
    ...
    #                          "collection_facet" =>7,
    #                                  "object_type_facet" => 7
    config.add_facet_field solr_name('names_facet', :facetable), :label => 'Names', :limit => 7 
    config.add_facet_field solr_name('year_facet', :facetable), :label => 'Year', :limit => 7 
    config.add_facet_field solr_name('subject_facet', :facetable), :label => 'Subject', :limit => 7 
    config.add_facet_field solr_name('object_type_facet', :facetable), :label => 'Format', :limit => 7
    ...
    config.add_show_field 'source2_ssm', :label => 'Source:'
    config.add_show_field 'description_ssm', :label => 'Description:'
    config.add_show_field 'identifier_ssm', :label => 'Identifier:'
    config.add_show_field 'dateCreated_ssm', :label => 'Date Created:'
    config.add_show_field 'dateAvailable_ssm', :label => 'Date Available:'
    config.add_show_field 'dateIssued_ssm', :label => 'Date Issued:'
    config.add_show_field 'rights_ssm', :label => 'Rights:'
    config.add_show_field 'bilbiographicCitation_ssm', :label => 'Bibliographic Citation:'
    config.add_show_field 'publisher_ssm', :label => 'Publisher:'
    config.add_show_field 'type2_ssm', :label => 'Type:'
    config.add_show_field 'format2_ssm', :label => 'Format:'
    config.add_show_field 'extent_ssm', :label => 'Extent:'
    config.add_show_field 'persname_ssm', :label => 'Person:'
    config.add_show_field 'corpname_ssm', :label => 'Corporation:'
    config.add_show_field 'geogname_ssm', :label => 'Place:'
    config.add_show_field 'genre_ssm', :label => 'Genre:'
    config.add_show_field 'funder_ssm', :label => 'Subject:'
    config.add_show_field 'temporal_ssm', :label => 'Temporal:'
    config.add_show_field 'resolution_ssm', :label => 'Resolution:'
    config.add_show_field 'bitDepth_ssm', :label => 'Bit Depth:'
    config.add_show_field 'colorSpace_ssm', :label => 'Color Space:'
    config.add_show_field 'filesize_ssm', :label => 'File Size:'


    #config.add_show_field solr_name('author_vern', :stored_searchable, type: :string), :label => 'Author:'
    #config.add_show_field solr_name('format2', :symbol), :label => 'Format:'
